...
SOURCE_DIR="/home/david/a_respaldar"  # Directorio a respaldar
...
PYTHON_SCRIPT="/media/sf_compartido/taller/send_backup.py"  # Ruta al script de Python para enviar correos
